...
var LY525popup = flightdetail("LY525", "LY", "",aircrafts.DG_86.image,4,3,flags.Layr,""); 
var LY524popup = flightdetail("LY524", "LY", "",aircrafts.DG_86.image,3,4,flags.Layr,""); 
var LY517popup = flightdetail("LY517", "LY", "",aircrafts.W36.image,4,3,flags.Layr,""); 
var LY516popup = flightdetail("LY516", "LY", "",aircrafts.W36.image,3,4,flags.Layr,""); 
var LY241popup = flightdetail("LY241", "LY", "",aircrafts.W36.image,3,3,flags.Layr,""); 
var LY240popup = flightdetail("LY240", "LY", "",aircrafts.W36.image,3,3,flags.Layr,""); 
var LY132popup = flightdetail("LY132", "LY", "",aircrafts.W34.image,3,2,flags.Layr,""); 
var LY133popup = flightdetail("LY133", "LY", "",aircrafts.W34.image,2,3,flags.Layr,""); 
var LY131popup = flightdetail("LY131", "LY", "",aircrafts.W34.image,2,3,flags.Layr,""); 
var LY130popup = flightdetail("LY130", "LY", "",aircrafts.W34.image,3,2,flags.Layr,""); 
var LY247popup = flightdetail("LY247", "LY", "",aircrafts.W34.image,3,2,flags.Layr,""); 
var LY246popup = flightdetail("LY246", "LY", "",aircrafts.W34.image,2,3,flags.Layr,""); 
var LY615popup = flightdetail("LY615", "LY", "",aircrafts.W34.image,4,3,flags.Layr,""); 
var LY616popup = flightdetail("LY616", "LY", "",aircrafts.W34.image,3,4,flags.Layr,""); 
var LY618popup = flightdetail("LY618", "LY", "",aircrafts.W34.image,4,3,flags.Layr,""); 
var LY876popup = flightdetail("LY876", "LY", "",aircrafts.W39.image,8,3,flags.Layr,""); 
var LY874popup = flightdetail("LY874", "LY", "",aircrafts.W39.image,8,3,flags.Layr,""); 
var LY875popup = flightdetail("LY875", "LY", "",aircrafts.W39.image,3,8,flags.Layr,""); 
var LY873popup = flightdetail("LY873", "LY", "",aircrafts.W39.image,3,8,flags.Layr,""); 
var GK003popup = flightdetail("GK003", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK004popup = flightdetail("GK004", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK006popup = flightdetail("GK006", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK008popup = flightdetail("GK008", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK005popup = flightdetail("GK005", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK007popup = flightdetail("GK007", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK011popup = flightdetail("GK011", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK013popup = flightdetail("GK013", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK012popup = flightdetail("GK012", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK014popup = flightdetail("GK014", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK015popup = flightdetail("GK015", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK016popup = flightdetail("GK016", "GK", "",aircrafts.Contair_D20a.image,5,5,flags.Gekdreg,onesky); 
var GK017popup = flightdetail("GK017", "GK", "",aircrafts.W36.image,5,5,flags.Gekdreg,onesky); 
var GK019popup = flightdetail("GK019", "GK", "",aircrafts.W36.image,5,5,flags.Gekdreg,onesky); 
var GK018popup = flightdetail("GK018", "GK", "",aircrafts.W36.image,5,5,flags.Gekdreg,onesky); 
var GK020popup = flightdetail("GK020", "GK", "",aircrafts.W36.image,5,5,flags.Gekdreg,onesky); 
var DS003popup = flightdetail("DS003", "DS", "",aircrafts.W34.image,4,5,flags.Kofuku,""); 
var DS004popup = flightdetail("DS004", "DS", "",aircrafts.W34.image,4,5,flags.Kofuku,""); 
var DS005popup = flightdetail("DS005", "DS", "",aircrafts.W34.image,4,5,flags.Kofuku,""); 
var DS006popup = flightdetail("DS006", "DS", "",aircrafts.W34.image,5,4,flags.Kofuku,""); 
var DS007popup = flightdetail("DS007", "DS", "",aircrafts.W34.image,5,4,flags.Kofuku,""); 
var DS008popup = flightdetail("DS008", "DS", "",aircrafts.W34.image,5,4,flags.Kofuku,""); 
var DS220popup = flightdetail("DS220", "DS", "",aircrafts.W39.image,4,8,flags.Kofuku,""); 
var DS221popup = flightdetail("DS221", "DS", "",aircrafts.W39.image,4,8,flags.Kofuku,""); 
var DS222popup = flightdetail("DS222", "DS", "",aircrafts.W39.image,8,4,flags.Kofuku,""); 
var DS223popup = flightdetail("DS223", "DS", "",aircrafts.W39.image,8,4,flags.Kofuku,""); 
var DS124popup = flightdetail("DS124", "DS", "",aircrafts.DG_86.image,4,8,flags.Kofuku,""); 
var DS125popup = flightdetail("DS125", "DS", "",aircrafts.DG_86.image,4,8,flags.Kofuku,""); 
var DS126popup = flightdetail("DS126", "DS", "",aircrafts.DG_86.image,8,4,flags.Kofuku,""); 
var DS127popup = flightdetail("DS127", "DS", "",aircrafts.DG_86.image,8,4,flags.Kofuku,""); 
var DS128popup = flightdetail("DS128", "DS", "",aircrafts.DG_86.image,4,3,flags.Kofuku,""); 
var DS129popup = flightdetail("DS129", "DS", "",aircrafts.DG_86.image,4,3,flags.Kofuku,""); 
var DS130popup = flightdetail("DS130", "DS", "",aircrafts.DG_86.image,3,4,flags.Kofuku,""); 
var DS131popup = flightdetail("DS131", "DS", "",aircrafts.DG_86.image,3,4,flags.Kofuku,""); 
var DS132popup = flightdetail("DS132", "DS", "",aircrafts.W39.image,4,2,flags.Kofuku,""); 
var DS133popup = flightdetail("DS133", "DS", "",aircrafts.W39.image,4,2,flags.Kofuku,""); 
var DS134popup = flightdetail("DS134", "DS", "",aircrafts.W39.image,2,4,flags.Kofuku,""); 
var DS135popup = flightdetail("DS135", "DS", "",aircrafts.W39.image,2,4,flags.Kofuku,""); 
var DS136popup = flightdetail("DS136", "DS", "",aircrafts.DG_86.image,5,5,flags.Kofuku,""); 
var DS137popup = flightdetail("DS137", "DS", "",aircrafts.DG_86.image,5,5,flags.Kofuku,""); 
var DS138popup = flightdetail("DS138", "DS", "",aircrafts.DG_86.image,5,5,flags.Kofuku,""); 
var DS139popup = flightdetail("DS139", "DS", "",aircrafts.DG_86.image,5,5,flags.Kofuku,""); 
var DS140popup = flightdetail("DS140", "DS", "",aircrafts.W36.image,5,5,flags.Kofuku,""); 
var DS141popup = flightdetail("DS141", "DS", "",aircrafts.W36.image,5,5,flags.Kofuku,""); 
var DS142popup = flightdetail("DS142", "DS", "",aircrafts.W36.image,5,5,flags.Kofuku,""); 
var DS143popup = flightdetail("DS143", "DS", "",aircrafts.W36.image,5,5,flags.Kofuku,""); 
