...
function flightdetail(flightobject, airlineobject, optcollab, image, fromZone, toZone, flag, allianceimage){
    ...
    datapopup = datapopup + " <table> <tr><td colspan=\"2\" style=\"text-align:left; padding-left:15px; padding-bottom:2px; font-size:15; color:black; background-color:#DCDCDC;\"> <b>Aircraft Details </b> </td> </tr> <tr><td colspan=\"2\" style=\"text-align:left; padding-top: 8px; padding-left:15px; font-size:15; color:grey;\"> <b>Aircraft </b>  <span style=\"padding-left: 15px; color:black; font-size:15;\">" + aircrafts[flights[flightobject].aircraft].name + "</span></td> </tr> <tr><td colspan=\"2\" style=\"text-align:left; padding-left:15px; font-size:15; color:grey;\"> <b>Class </b>  <span style=\"padding-left: 28px; font-size:15; color:black;\">" + aircrafts[flights[flightobject].aircraft].class + "</span></td> </tr> <tr><td style=\"text-align:left; color:grey; padding-left:15px; font-size:15;\"><b>Cr. Speed </b>  <span style=\"padding-left: 15px; color:black; font-size:15;\">" + aircrafts[flights[flightobject].aircraft].speed + " km/h</span></td><td style=\"text-align:left; font-size:15; color:grey;\"> <b>Capacity</b>  <span style=\"padding-left: 35px; font-size:15; color:black;\">" + aircrafts[flights[flightobject].aircraft].capacity + "</span></td></tr> <tr><td style=\"text-align:left; color:grey; padding-left:15px; font-size:15;\"><b>Age </b>  <span style=\"padding-left: 55px; color:black; font-size:15;\">" + flights[flightobject].age + "</span></td><td style=\"text-align:left; font-size:15; color:grey;\"> <b>Country Reg. &nbsp </b>" +  flag + "</td></tr> </table> ";
    datapopup = datapopup + " <table> <tr><td colspan=\"2\" style=\"text-align:left; padding-left:15px; padding-bottom:2px; font-size:15; color:black; background-color:#DCDCDC;\"> <b>Airline Details </b> </td> </tr> <tr><td colspan=\"2\" style=\"text-align:left; padding-top: 8px; padding-left:15px; font-size:15; color:grey;\"> <b>Airline </b>  <span style=\"padding-left: 15px; color:black; font-size:15;\">" + airlines[airlineobject].name + "</span></td> </tr> <tr><td style=\"text-align:left; color:grey; padding-left:15px; font-size:15;\"><b>WAAT </b>  <span style=\"padding-left: 19px; color:black; font-size:15;\">" + airlines[airlineobject].WAAT + "</span></td><td style=\"text-align:left; font-size:15; color:grey;\"> <b style=\"padding-left: 62px;\">Callsign</b>  <span style=\"padding-left: 15px; font-size:15; color:black;\">" + airlines[airlineobject].callsign + "</span></td></tr>  </tr> <tr><td colspan=\"2\" style=\"text-align:left; padding-left:15px; font-size:15; color:grey;\"> <b>Alliance </b>  <span style=\"padding-left: 5px; color:black; font-size:15;\">" + airlines[airlineobject].alliance + "&nbsp &nbsp" + allianceimage + "</span></td> </tr> ";
    return datapopup;
}
